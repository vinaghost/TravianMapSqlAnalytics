...
{
    public record VillageContainsPopulationHistoryParameters : IPaginationParameters, IVillageFilterParameter, IPopulationHistoryFilterParameter
    {
        ...
        public string Key => $"{PageNumber}_{PageSize}_{MinPopulation}_{MaxPopulation}_{Tribe}_{IgnoreCapital}_{IgnoreNormalVillage}_{string.Join(',', Alliances)}_{string.Join(',', Players)}_{MinChangePopulation}_{MaxChangePopulation}_{Date}";
